...
//function to add a residency to a favourite list of a user
export const toFav = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    // Ensure that favResidenciesID is initialized as an array
    const favResidenciesID = user.favResidenciesID || [];
    
    console.log('user:', user);
    console.log('favResidenciesID:', favResidenciesID);
